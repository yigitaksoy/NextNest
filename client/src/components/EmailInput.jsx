      ...
      <div className="p-2">
        <div className="relative">
          ...
          <input
            type="email"
            id="maxPrice"
            className="search-input input block w-full rounded-lg border border-transparent p-2.5 pl-10 text-sm focus:border-sky-300 focus:outline-none focus:ring-0 hover:border-sky-300"
            placeholder="E-mail"
